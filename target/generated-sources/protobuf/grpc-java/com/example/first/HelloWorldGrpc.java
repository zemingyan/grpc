...
public final class HelloWorldGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.first.Greeting,
      com.example.first.HelloResp> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHello",
      requestType = com.example.first.Greeting.class,
      responseType = com.example.first.HelloResp.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.first.Greeting,
      com.example.first.HelloResp> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.example.first.Greeting, com.example.first.HelloResp> getSayHelloMethod;
      ...
      synchronized (HelloWorldGrpc.class) {
        if ((getSayHelloMethod = HelloWorldGrpc.getSayHelloMethod) == null) {
          HelloWorldGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<com.example.first.Greeting, com.example.first.HelloResp>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "HelloWorld", "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.first.Greeting.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.first.HelloResp.getDefaultInstance()))
  ...
  public static abstract class HelloWorldImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.example.first.Greeting request,
        io.grpc.stub.StreamObserver<com.example.first.HelloResp> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.example.first.Greeting,
                com.example.first.HelloResp>(
  ...
  public static final class HelloWorldBlockingStub extends io.grpc.stub.AbstractStub<HelloWorldBlockingStub> {
    ...
    /**
     */
    public com.example.first.HelloResp sayHello(com.example.first.Greeting request) {
  ...
  public static final class HelloWorldFutureStub extends io.grpc.stub.AbstractStub<HelloWorldFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.first.HelloResp> sayHello(
        com.example.first.Greeting request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.example.first.Greeting) request,
              (io.grpc.stub.StreamObserver<com.example.first.HelloResp>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloWorldBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.first.HelloWorldProto.getDescriptor();
    }
