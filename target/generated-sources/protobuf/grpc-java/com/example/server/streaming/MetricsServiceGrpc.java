...
@javax.annotation.Generated(
    ...
    comments = "Source: stream/StreamingExample.proto")
public final class MetricsServiceGrpc {

  private MetricsServiceGrpc() {}

  public static final String SERVICE_NAME = "com.example.server.streaming.MetricsService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.example.server.streaming.StreamingExample.Metric,
      com.example.server.streaming.StreamingExample.Average> getCollectMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "collect",
      requestType = com.example.server.streaming.StreamingExample.Metric.class,
      responseType = com.example.server.streaming.StreamingExample.Average.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.example.server.streaming.StreamingExample.Metric,
      com.example.server.streaming.StreamingExample.Average> getCollectMethod() {
    io.grpc.MethodDescriptor<com.example.server.streaming.StreamingExample.Metric, com.example.server.streaming.StreamingExample.Average> getCollectMethod;
      ...
      synchronized (MetricsServiceGrpc.class) {
        if ((getCollectMethod = MetricsServiceGrpc.getCollectMethod) == null) {
          MetricsServiceGrpc.getCollectMethod = getCollectMethod = 
              io.grpc.MethodDescriptor.<com.example.server.streaming.StreamingExample.Metric, com.example.server.streaming.StreamingExample.Average>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "com.example.server.streaming.MetricsService", "collect"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.server.streaming.StreamingExample.Metric.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.server.streaming.StreamingExample.Average.getDefaultInstance()))
  ...
  public static abstract class MetricsServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.example.server.streaming.StreamingExample.Metric> collect(
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncClientStreamingCall(
              new MethodHandlers<
                com.example.server.streaming.StreamingExample.Metric,
                com.example.server.streaming.StreamingExample.Average>(
  ...
  private static abstract class MetricsServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.server.streaming.StreamingExample.getDescriptor();
    }
